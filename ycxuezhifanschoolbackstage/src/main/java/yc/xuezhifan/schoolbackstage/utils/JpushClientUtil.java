 ...
 * 极光推送类
 * @author linxiao
 * @version 创建时间：2018年8月9日 上午8:55:10
 */
public class JpushClientUtil {
	private final static String appKey = "5080125824218399f61f2eb7";

	private final static String masterSecret = "1a40d4479e80fec7d50d2acc";
	 ...
	 * @return 0推送失败，1推送成功
	 */
	public static int sendToMultipleUsers(String[]registrationId, String notification_title, String msg_title,
			String msg_content, String extrasparam) {
		int result = 0;
		try {
			PushPayload pushPayload = JpushClientUtil.buildPushObject_all_MultipleUsers_alertWithTitle(registrationId,
					notification_title, msg_title, msg_content, extrasparam);
			System.out.println(pushPayload);
			PushResult pushResult = jPushClient.sendPush(pushPayload);
			System.out.println(pushResult);
...
//		Builder builder = IosAlert.newBuilder().setTitleAndBody("title", "subtitle", "body");
	 ...
	 * @return 0推送失败，1推送成功
	 */
	public static PushPayload buildPushObject_all_MultipleUsers_alertWithTitle(String[] registrationId,
			String notification_title, String msg_title, String msg_content, String extrasparam) {
